...
import { Printer, RotateCcw, Check, X, SkipForward, Award, BookOpen } from "lucide-react";
...
export default function ScoreScreen({ quizData, answers, timeTaken, onRestart }: ScoreScreenProps) {
  let correctCount = 0;
  let wrongCount = 0;
  let skippedCount = 0;
  ...
  return (
    <div className="w-full max-w-3xl mx-auto px-4 space-y-8">
      ...
      <div className="space-y-6">
        <div className="flex items-center space-x-2 px-1 border-b border-zinc-900 pb-3">
            ...
            return (
              ...
              >
                <div className="flex items-center justify-between text-xs font-mono">
                  <span className="text-zinc-500 uppercase tracking-widest font-semibold">QUESTION {idx + 1} OF {quizData.questions.length}</span>
                ...
                <div className="bg-zinc-950/90 p-4.5 rounded-2xl border border-zinc-900 text-xs">
                  ...
                  <p className="text-zinc-300 leading-relaxed font-sans italic pl-3 border-l border-zinc-805">
                    {q.explanation}
                  </p>
                </div>
              </motion.div>
